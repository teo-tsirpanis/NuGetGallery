...
Invoke-BuildStep 'Creating artifacts' { `
    ...
    New-Package (Join-Path $PSScriptRoot "src\SlowEfQuery\SlowEfQuery.nuspec") -Configuration $Configuration -BuildNumber $BuildNumber -Version $SemanticVersion -Branch $Branch -MSBuildVersion "15"
